        ...
        <>
            <section>
                <div className='container m-auto py-6 px-6'>
                    ...
                    to='/jobs'><FaArrowLeft className='mr-2'/> Back to Jobs</Link>
                </div>
            </section>
            <section className='bg-indogo-50'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-70/30 w-full gap-6'>
                        ...
                        <aside>
                             <div className='bg-white p-6 rounded-lg shadow-md'>
                                ...
                                <p className='py-2'>{job.company.description}</p>
                             ...
                             <div className='bg-white p-6 rounded shadow-md mt-6'>
                                ...
                                <button 
                                className='bg-red-500 hover:bg-red-600 text-white text-center py-2 px-4 rounded-full w-full  focus:outline-none focus:shadow-outline mt-4 block'
                                >Delete Job</button>
                             </div>
                        </aside>
                    </div>
